...
export const demoChannelTitle: string   = 'eeennsu';
export const demoVideoTitle: string     = 'Build and Deploy 5 JavaScript & React API Projects in 10 Hours - Full Course | RapidAPI';
